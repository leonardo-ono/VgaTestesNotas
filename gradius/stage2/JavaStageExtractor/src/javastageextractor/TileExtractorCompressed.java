 ...
 * @author admin
 */
public class TileExtractorCompressed extends JPanel  {

    private BufferedImage image;
    private BufferedImage outImage;

    public TileExtractorCompressed() {
        try {
    ...
    public static String getMD5(BufferedImage originalImage) {
        ...
        try {
            ...
            Logger.getLogger(TileExtractorCompressed.class.getName()).log(Level.SEVERE, null, ex);
            System.exit(-1);
        }
        return sb.toString();
    }
    ...
    public static void main(String[] args) throws Exception {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                TileExtractorCompressed view = new TileExtractorCompressed();
