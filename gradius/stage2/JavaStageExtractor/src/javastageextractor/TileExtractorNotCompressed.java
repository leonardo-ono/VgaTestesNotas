 ...
 * @author admin
 */
public class TileExtractorNotCompressed extends JPanel  {

    private BufferedImage image;
    private BufferedImage outImage;

    public TileExtractorNotCompressed() {
        try {
...
//        System.out.println("compressed size: " + compressedSize);
    ...
    public static String getMD5(BufferedImage originalImage) {
        ...
        try {
            ...
            Logger.getLogger(TileExtractorNotCompressed.class.getName()).log(Level.SEVERE, null, ex);
            System.exit(-1);
        }
        return sb.toString();
    }
    ...
    public static void main(String[] args) throws Exception {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                TileExtractorNotCompressed view = new TileExtractorNotCompressed();
