...
start:
		...
		;mov di, [spr_0.restore_location_1] ; 82 * 100 + 40 ; di = vram location
		;call draw_sprite_4_page

		;mov di, [spr_0.restore_location_1] ; 82 * 100 + 40 ; di = vram location
		;call draw_sprite_complete
	...
	.next_frame:
		...
		;mov di, [spr_0.restore_location] ; 82 * 100 + 40 ; di = vram location
		;call draw_sprite_4_page
		
		mov di, [spr_0.restore_location]
		call draw_sprite_complete
		mov di, [spr_1.restore_location]
		call draw_sprite_complete
		mov di, [spr_2.restore_location]
		call draw_sprite_complete
		mov di, [spr_3.restore_location]
		call draw_sprite_complete
		...
		mov di, [spr_0.restore_location_1]
		call draw_sprite_complete
		mov di, [spr_1.restore_location_1]
		call draw_sprite_complete
		mov di, [spr_2.restore_location_1]
		call draw_sprite_complete
		mov di, [spr_3.restore_location_1]
		call draw_sprite_complete
